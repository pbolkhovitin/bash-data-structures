...
Используйте массивы Bash - они быстрее чем эмуляция через строки

Избегайте подпроцессов в циклах обработки

Используйте локальные переменные с local

Минимизируйте вызовы внешних команд в горячих путях
